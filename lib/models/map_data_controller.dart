...
//
//     final googlemapapi = googlemapapiFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

Googlemapapi googlemapapiFromJson(String str) =>
    Googlemapapi.fromJson(json.decode(str));

String googlemapapiToJson(Googlemapapi data) => json.encode(data.toJson());
...
class Googlemapapi {
  ...
  factory Googlemapapi.fromJson(Map<String, dynamic> json) => Googlemapapi(
